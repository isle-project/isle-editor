...
const CheckboxInput = require( 'components/checkbox-input' );
...
const FunctionPlot = require( 'components/function-plot' );
...
const SelectInput = require( 'components/select-input' );
const SliderInput = require( 'components/slider-input' );
