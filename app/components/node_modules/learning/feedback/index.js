	...
	constructor() {
		...
		*/
		...
		this.submitFeedback = () => {
			...
			// Fetch form values.
			const formData = {
				checkbox01: findDOMNode( this.refs.checkbox01 ).value,
				checkbox02: findDOMNode( this.refs.checkbox02 ).value,
				checkbox03: findDOMNode( this.refs.checkbox03 ).value,
				text: findDOMNode( this.refs.textarea ).value
			};
