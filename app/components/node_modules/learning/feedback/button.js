...
class FeedbackButton extends Component {
	...
	*/
	showFeedbackForm() {
		const verticalPosition = $( document ).scrollTop();
		...
		*/
		...
		const feedbackForm = ReactDOM.render(
			<FeedbackForm
				submitHandler={submitFeedback}
				closeHandler={removeFeedbackForm}
				top={top}
			/>,
	...
	*/
	...
	/*
	* Displays the appropriate feedback response after user has clicked
	* on one of the feedback buttons.
	*
