		...
		this.submitHandler = ( event ) => {
			if ( this.state.submitted ) {
				...
				global.lesson.addNotification({
					...
					message: 'Compare your answer with solution using the "Show Solution" button. You can then change your answer and re-submit if necessary.',
					level: 'success',
					position: 'tr'
				});
			}
	...
	render() {
		...
		return (
			<Panel className="FreeFormQuestion">
				{ this.props.legend ? <h4>{this.props.legend}</h4> : null }
