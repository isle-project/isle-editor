...
class RShell extends React.Component {
	constructor( props ) {
		...
		this.handleEvaluationClick = () => {
			...
			currentCode = requireLibs( libs ) + globalCode + this.props.prependCode + currentCode;
...
RShell.propTypes = {
	...
	addPrecedingCode: PropTypes.bool
};
