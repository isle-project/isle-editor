...
class RShell extends React.Component {
	constructor( props ) {
		...
		this.handleEvaluationClick = () => {
			...
			currentCode = requireLibs( libs ) + globalCode + currentCode;
		...
		return (
			...
			>
				...
				<ButtonToolbar style={{ float: 'right', marginTop: '8px' }}>
					...
					{ ( this.props.solution && !this.state.disabled ) ? showSolutionButton( this.state.currentHint, nHints, this.handleSolutionClick ) : null }
				</ButtonToolbar>
				<div id="output">
