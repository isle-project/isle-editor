...
function writeIndexFile( outputPath, lessonContent, meta, clbk ) {
	...
	const NON_PACKAGED = /node_modules\/electron-prebuilt\/dist/;

	let webpacker = null;
	if ( NON_PACKAGED.test( process.resourcesPath ) ) {
		webpacker = spawn( './node_modules/webpack/bin/webpack.js', [
			'--config',
		...
		webpacker = spawn( `${process.resourcesPath}/app/node_modules/webpack/bin/webpack.js`, [
			'--config',
			`${process.resourcesPath}/app/app/components/node_modules/bundler/webpack.config.export.js`,
			indexPath,
			bundlePath
		]);
	}
