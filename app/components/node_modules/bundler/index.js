...
function writeIndexFile( outputPath, lessonContent, meta, minify, clbk ) {
	...
	const getCSSPath = ( file ) => {
		return isPackaged ?
		`${process.resourcesPath}/app/app/css/${file}` :
		path.resolve( `./app/css/${file}` );
	};
	...
	// Copy CSS files:
	fs.mkdirSync( path.join( appDir, 'css' ) );
	fs.copySync( getCSSPath( 'bootstrap-theme.min.css' ), path.join( appDir, 'css/bootstrap-theme.min.css' ) );
	fs.copySync( getCSSPath( 'bootstrap.min.css' ), path.join( appDir, 'css/bootstrap.min.css' ) );
	fs.copySync( getCSSPath( 'fixed-data-table.min.css' ), path.join( appDir, 'css/fixed-data-table.min.css' ) );
	fs.copySync( getCSSPath( 'slick.min.css' ), path.join( appDir, 'css/slick.min.css' ) );
	fs.copySync( getCSSPath( 'slick-theme.min.css' ), path.join( appDir, 'css/slick-theme.min.css' ) );
	fs.copySync( getCSSPath( 'katex.min.css' ), path.join( appDir, 'css/katex.min.css' ) );
	fs.copySync( getCSSPath( 'lesson.css' ), path.join( appDir, 'css/lesson.css' ) );
