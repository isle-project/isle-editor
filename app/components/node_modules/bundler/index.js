		...
		loaders: [
			{
				...
				include: isPackaged ?
				[
					`${process.resourcesPath}/app/main.development.js`
					`${process.resourcesPath}/app/app`,
					`${process.resourcesPath}/node_modules/@stdlib`,
				] :
				[
					path.resolve( './main.development.js' ),
					path.resolve( './app' ),
					path.resolve( './node_modules/@stdlib' ),
				],
				query: {
					plugins: [
						'add-module-exports'
