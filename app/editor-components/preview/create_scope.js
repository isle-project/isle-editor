...
const SCOPE = {
	...
	Bibliography: Loadable( () => import( 'components/bibliography' ) ),
	CheckboxInput: CheckboxInput,
	Calculator: Loadable( () => import( 'components/calculator' ) ),
	Citation: Loadable( () => import( 'components/citation' ) ),
	...
	Image: Loadable( () => import( 'components/image' ) ),
	...
	RandomVideo: Loadable( () => import( 'components/random-video' ) ),
	RangeQuestion: Loadable( () => import('components/range-question' ) ),
	Reaction: Loadable( () => import( 'components/reaction' ) ),
