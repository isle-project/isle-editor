...
import VictoryAxis from '@isle-project/components/victory/axis';
import VictoryAnimation from '@isle-project/components/victory/animation';
import VictoryArea from '@isle-project/components/victory/area';
import VictoryBar from '@isle-project/components/victory/bar';
import VictoryBoxPlot from '@isle-project/components/victory/boxplot';
import VictoryBrushContainer from '@isle-project/components/victory/brush-container';
import VictoryCandlestick from '@isle-project/components/victory/candlestick';
import VictoryChart from '@isle-project/components/victory/chart';
import VictoryContainer from '@isle-project/components/victory/container';
import VictoryCursorContainer from '@isle-project/components/victory/cursor-container';
import VictoryGroup from '@isle-project/components/victory/group';
import VictoryErrorBar from '@isle-project/components/victory/error-bar';
import VictoryLabel from '@isle-project/components/victory/label';
import VictoryLegend from '@isle-project/components/victory/legend';
import VictoryLine from '@isle-project/components/victory/line';
import VictoryPie from '@isle-project/components/victory/pie';
import VictoryPolarAxis from '@isle-project/components/victory/polaraxis';
import VictoryScatter from '@isle-project/components/victory/scatter';
import VictoryStack from '@isle-project/components/victory/stack';
import VictoryTheme from '@isle-project/components/victory/theme';
import VictoryTooltip from '@isle-project/components/victory/tooltip';
import VictoryVoronoiContainer from '@isle-project/components/victory/voronoi-container';
import VictoryZoomContainer from '@isle-project/components/victory/zoom-container';
import VictoryWrapper from '@isle-project/components/victory/wrapper';

import SlideAppear from '@isle-project/components/spectacle/components/appear';
import Deck from '@isle-project/components/spectacle/components/deck';
import SlideNotes from '@isle-project/components/spectacle/components/notes';
import Slide from '@isle-project/components/spectacle/components/slide';
