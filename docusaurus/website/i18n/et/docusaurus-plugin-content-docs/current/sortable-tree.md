...
Õhuke ümbris [react-sortable-tree](https://www.npmjs.com/package/react-sortable-tree), mis toetab kõiki nimetatud komponendi omadusi.
...
* __title__ | `string`: päise pealkiri. Default: `none`.
