...
* __variable__ | `(array|string) (required)`: näytettävät muuttujat. Default: `none`.
* __group__ | `(array|string|Factor)`: yksi tai kaksi ryhmittelymuuttujaa. Default: `[]`.
* __orientation__ | `string`: "pystysuora" tai "vaakasuora" suuntaus. Default: `'vertical'`.
* __overlayPoints__ | `boolean`: valvoo pisteiden päällekkäisyyttä. Default: `false`.
