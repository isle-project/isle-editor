...
* __target__ | `string`: määrittelee, mistä linkki avataan: asetetaan arvoksi `_blank`, jos kyseessä on uusi ikkuna, `_self`, jos kyseessä on oma kehys, `_parent`, jos kyseessä on vanhempi, `_top`, jos kyseessä on koko ikkunan runko, tai kehyksen nimi.. Default: `none`.
...
* __openWindow__ | `boolean`: boolean, joka ohjaa, avataanko URL-osoite uudessa ikkunassa.. Default: `false`.
