...
Tenký obal kolem komponenty [react-sortable-tree](https://www.npmjs.com/package/react-sortable-tree), který podporuje všechny vlastnosti uvedené komponenty.
...
* __title__ | `string`: název záhlaví. Default: `none`.
