...
Тънка обвивка около [react-sortable-tree](https://www.npmjs.com/package/react-sortable-tree), която поддържа всички свойства на посочения компонент.
...
* __title__ | `string`: заглавие на заглавието. Default: `none`.
